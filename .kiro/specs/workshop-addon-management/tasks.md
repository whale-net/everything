...
- [ ] 5. Workshop Manager service (Control Plane)
  - [x] 5.1 Create WorkshopManager in manmanv2/api/workshop/manager.go
  ...
  - [x] 5.2 Implement InstallAddon method
  ...
  - [x] 5.3 Write property tests for InstallAddon
  ...
  - [x] 5.4 Implement FetchAndCreateAddon method
  ...
  - [x] 5.5 Write property test for collection expansion
    - **Property 34: Collection Expansion**
    - **Validates: Requirements 14.2, 14.3**
  
  - [x] 5.6 Implement RemoveInstallation method
    - Validate no active sessions using the addon
    - Delete installation record
    - Publish removal command to host manager
    - _Requirements: 10.1, 10.3, 10.5_
  
  - [x] 5.7 Write property tests for removal
    - **Property 28: Active Session Protection**
    - **Validates: Requirements 10.5**

- [x] 6. Checkpoint - Ensure control plane tests pass
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 7. Download Orchestrator (Host Manager Component)
  - [x] 7.1 Create DownloadOrchestrator in manmanv2/host/workshop/orchestrator.go
  ...
  - [x] 7.2 Implement HandleDownloadCommand method
  ...
  - [x] 7.3 Write property tests for download orchestration
  ...
  - [x] 7.4 Implement SteamCMD command building
  ...
  - [x] 7.5 Write property test for SteamCMD command format
    - **Property 22: SteamCMD Command Format**
    - **Validates: Requirements 8.1, 8.2**
  
  - [x] 7.6 Implement progress parsing from SteamCMD logs
  ...
  - [x] 7.7 Write property tests for log parsing
  ...
  - [x] 7.8 Implement retry logic with exponential backoff
...
- [ ] 8. RabbitMQ integration
  ...
  - [x] 8.4 Add installation status handler to API server
...
- [x] 9. Checkpoint - Ensure download orchestration works
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 10. gRPC API service
  - [x] 10.1 Define WorkshopService protobuf in manmanv2/protos/workshop.proto
  ...
  - [x] 10.2 Generate Go code from protobuf
    - Run protoc to generate Go code
    - Verify generated code compiles
    - _Requirements: 6.1_
  
  - [x] 10.3 Implement WorkshopServiceHandler in manmanv2/api/handlers/workshop.go
  ...
  - [x] 10.4 Write property tests for addon API
