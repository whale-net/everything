...
- [ ] 1. Database schema and migrations
  - [ ] 1.1 Create migration for workshop_addons table
  ...
  - [ ] 1.2 Create migration for workshop_installations table
  ...
  - [ ] 1.3 Create migration for workshop_libraries tables
  ...
  - [ ] 1.4 Create down migrations for rollback
...
- [ ] 2. Go models and constants
  - [ ] 2.1 Add WorkshopAddon model to manmanv2/models.go
...
- [ ] 3. Repository layer implementation
  - [ ] 3.1 Create WorkshopAddonRepository interface and implementation
  ...
  - [ ]* 3.2 Write property tests for WorkshopAddonRepository
    - **Property 1: Addon Storage Round Trip**
    - **Validates: Requirements 1.1, 1.3, 1.6**
  
  - [ ]* 3.3 Write property tests for addon uniqueness and filtering
