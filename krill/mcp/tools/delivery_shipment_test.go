...
func (f deliveryShipmentFakeCredentialStore) Mint(context.Context, string) (string, mcpauth.Credential, error) {
	return "", mcpauth.Credential{}, errors.New("deliveryShipmentFakeCredentialStore.Mint is not used by this test")
}

func (f deliveryShipmentFakeCredentialStore) Verify(_ context.Context, rawToken string) (string, mcpauth.Credential, error) {
...
func (f deliveryShipmentFakeCredentialStore) List(context.Context, string) ([]mcpauth.Credential, error) {
	return nil, errors.New("deliveryShipmentFakeCredentialStore.List is not used by this test")
}

var _ mcpauth.CredentialStore = deliveryShipmentFakeCredentialStore{}
