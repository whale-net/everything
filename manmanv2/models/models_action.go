...
type ActionDefinition struct {
	...
	// DeletedAt is the FR9 soft-delete marker (migration 037, task #2092):
	// nil = live definition; non-nil = deleted -- excluded from listings
	// and execution, restored when an action is re-created at the same
	// (definition_level, entity_id, name).
