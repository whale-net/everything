...
# NOTE: WorkerAPIClient has been removed and replaced with WorkerDALClient
# WorkerDALClient is in //manman/clients:clients and uses the generated OpenAPI client
# It can be used by worker services and other consumers that don't have circular dependencies