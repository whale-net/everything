...
| [`architecture/02-mcp-server.md`](architecture/02-mcp-server.md) | The `mcp` binary: SDK choice, YouTube client wiring, caller authentication (auth/OAuth2, plus the parallel whagent-net path, issue #2116/FR12), Channel-scoping + idempotency middleware, statelessness (LB4), observability |
