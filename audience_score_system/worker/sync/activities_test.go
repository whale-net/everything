...
// SyncOutcomes is real as of #1581 -- see outcomes_test.go for its
// coverage (this file previously asserted SyncOutcomes was a permanent
// no-op stub, per issue #1574's Scaffold status; that stub is gone).
