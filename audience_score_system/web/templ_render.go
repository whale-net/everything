...
// daisyUI (NFR1-style toolchain avoidance: no Node, no bundler, no CSS
// build step -- the image build stays a pure Go cross-compile). Mirrors
// leaflab/ui/templ_render.go, tools/app_registry/ui/templ_render.go, and
// manmanv2/ui/templ_render.go's RenderTempl/buildHead split.
//
