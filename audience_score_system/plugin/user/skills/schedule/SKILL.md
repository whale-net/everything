...
- Never call `save_schedule_draft` yourself in this skill's own steps — that judgment call belongs to the analyst persona, dispatched per idea, so its reasoning about pacing/collisions stays attached to that call.
