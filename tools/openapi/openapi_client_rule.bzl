...
load("//tools/openapi:platform_reset.bzl", "reset_openapi_codegen_config")
...
openapi_client_provider_rule = rule(
    ...
    attrs = {
        "tar": attr.label(allow_single_file = [".tar"], mandatory = True, cfg = reset_openapi_codegen_config),
