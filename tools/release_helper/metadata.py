...
from tools.release_helper.core.bazel import run_bazel, find_workspace_root
...
def get_image_targets(bazel_target: str) -> Dict[str, str]:
    ...
    return {
        ...
        "push_base": f"{base_image_target}_push",
        "push_amd64": f"{base_image_target}_push_amd64", 
        "push_arm64": f"{base_image_target}_push_arm64",
    }