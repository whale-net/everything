...
- [project-manager/README.md](project-manager/README.md) — AGY & Claude Code plugin: multi-persona GitHub-tracked planning pipeline (producer/architect/planner/writer/tester/validator/system-validator)
