...
- [pi_console/README.md](pi_console/README.md) — HTMX web UI for driving [pi.dev](https://pi.dev) coding agents in RPC mode across multiple hosts, via a small per-host bridge process
