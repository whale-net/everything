...
ESP32_DIO_80M = struct(
    ...
    # max_app_4MB.bin is generated by //tools/firmware/esp32:max_app_4MB_bin
    # (gen_esp32part.py from the arduino_esp32 core archive).
    pre_segments = [
        ("0x1000", "_main/tools/firmware/esp32/bootloader_dio_80m.bin"),
        ("0x8000", "_main/tools/firmware/esp32/max_app_4MB.bin"),
    ],
    # Labels for those same files — needed as data deps in the sh_binary.
    pre_segment_labels = [
        "//tools/firmware/esp32:bootloader_dio_80m_bin",
        "//tools/firmware/esp32:max_app_4MB_bin",
    ],
