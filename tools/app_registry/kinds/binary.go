...
type Binary struct {
	...
	// During Implementation (phase 2), each hook will be initialized with its
	// actual policy value. For now, they are stubs to satisfy the HookSet interface.
	h1 h1Hook
	h2 h2Hook
	h3 h3Hook
	h4 h4Hook
...
// Stub hook implementations. Each will be populated during Implementation.
