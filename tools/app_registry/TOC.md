...
| [RECOVERY.md](RECOVERY.md) | Recovery procedures when the registry API or external systems are unavailable — three acquisition escape hatches, the registry-unreachable recovery route, manual publish-by-hand, and understanding standing-check failures. An operator-facing runbook for emergency scenarios. |
