...
| [design/USER_JOURNEYS_2026-08-23_FOLLOWUPS.md](design/USER_JOURNEYS_2026-08-23_FOLLOWUPS.md) | Prioritizing what to actually build next — turns both playtest waves' findings into a ranked backlog of stories (P0 verification through P3 polish), each traceable back to the finding(s) it came from. Read this instead of re-deriving priorities from the two findings docs yourself |
