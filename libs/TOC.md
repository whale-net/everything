...
| `mcpobs` | Shared MCP tracing/logging middleware — server-side per-tool-call span/log wrapper and client-side trace-propagating transport wrap, so a caller's trace ID correlates across the MCP boundary | [README](go/mcpobs/README.md) |
