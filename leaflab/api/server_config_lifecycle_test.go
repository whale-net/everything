...
func TestGetConfigStatus_ReflectsCurrentState_Pending(t *testing.T) {
	...
	server := NewLeafLabAPIServer(repo, boardScopedAuthz(7), nil, nil, nil, discardLogger())
...
func TestListConfigHistory_CapDetection_NextPageTokenOnlyWhenExtraRowReturned(t *testing.T) {
	...
	exactServer := NewLeafLabAPIServer(exact, boardScopedAuthz(7), nil, nil, nil, discardLogger())
	...
	extraServer := NewLeafLabAPIServer(extra, boardScopedAuthz(7), nil, nil, nil, discardLogger())
...
func TestGetConfigStatus_NonMember_Refused(t *testing.T) {
	...
	server := NewLeafLabAPIServer(repo, nonMemberAuthz(7), nil, nil, nil, discardLogger())
...
func TestNonMemberRefusals_ByteIdenticalToNonexistentBoard(t *testing.T) {
	...
	outOfScopeServer := NewLeafLabAPIServer(&fakeRepo{}, nonMemberAuthz(7), nil, nil, nil, discardLogger())
