...
// Shared real-Postgres setup for every *_integration_test.go file in this
// package (both the api_integration_test and history_integration_test
// go_test targets embed this file) -- see repository_integration_test.go's
// doc comment and //libs/go/dbtest's README for how to run them.
package main
