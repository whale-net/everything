...
func run() error {
	...
	apiServer := NewLeafLabAPIServer(repo, authzSvc, publisher, rmqConn, logging.Get("api"), WithElevationDuration(elevationDuration), WithSupportReferenceTTL(supportReferenceTTL))
